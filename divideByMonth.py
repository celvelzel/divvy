...
file_path = 'C:\\Users\\celcelcel\\Desktop\\19Q12\\Divvy_Trips_2019_Q1.xlsx'
...
df_1.to_excel(os.path.join(output_folder, '2019.1.xlsx'), index=False)
df_2.to_excel(os.path.join(output_folder, '2019.2.xlsx'), index=False)
df_3.to_excel(os.path.join(output_folder, '2019.3.xlsx'), index=False)
